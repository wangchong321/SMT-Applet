...
test('clearStorage', async () => {
  ...
  expect(wx.getStorageSync('ta1'))
    .toBe(123)
  expect(wx.getStorageSync('ta2'))
    .toBe(321)
...
test('setStorageSync/getStorageSync', () => {
  ...
  expect(wx.getStorageSync('abc'))
    .toBe(123)

  wx.setStorageSync('cba', '123')
  expect(wx.getStorageSync('cba'))
    .toBe('123')
