...
test('createSelectorQuery', () => {
  ...
  expect(selectorQuery.constructor)
    .toBe(selectorQuery2.constructor)
  expect(selectorQuery._exparserNode)
    .toBe(selectorQuery2._exparserNode)
})
...
test('createIntersectionObserver', () => {
  ...
  expect(intersectionObserver.constructor)
    .toBe(intersectionObserver2.constructor)
  expect(intersectionObserver._exparserNode)
    .toBe(intersectionObserver2._exparserNode)
})
