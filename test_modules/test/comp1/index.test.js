...
function runTest(id) {
  ...
  comp.attach(parent)
  expect(simulate.match(comp.dom, '<wx-view class="main--index-text">index.test.properties</wx-view>'))
    .toBe(true)
  expect(window.getComputedStyle(comp.querySelector('.index-text').dom).color)
    .toBe('green')
